...
router.get('/', function (req, res) {
  res.render('index', { title: 'perfume App', user : req.user });
});
router.get('/register', function(req, res) {

  res.render('register', { title: 'perfume App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'perfume App Login', user : req.user });
});
